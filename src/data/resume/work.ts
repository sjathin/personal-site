...
const work: Position[] = [
  {
    ...
    highlights: [
      ...
      "Drove AI coding-agent adoption across the team by authoring detailed service context and reusable agent skills — grounding an existing agent in the team's services, ownership, and operational history to reduce hallucination; enabled autonomous on-call triage (investigating incidents, surfacing probable root cause, and writing worklog summaries before human involvement), higher-quality code reviews, and scripted auto-remediation of recurring issues — cutting first-pass investigation time by ~[TODO]% for [TODO]+ engineers.",
    ],
  },
  {
